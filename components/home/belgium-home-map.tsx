...
export function BelgiumHomeMap() {
  return (
    <div className="belgium-home-map-panel">
      <svg
        aria-label="Carte de la Belgique par communautes"
        className="belgium-home-map"
        role="img"
        viewBox="486.6 293.6 9.6 8.7"
      >
        <defs>
          <clipPath id="belgium-home-map-clip">
            <path d={BELGIUM_OUTLINE_PATH} />
          </clipPath>
        </defs>

        <rect className="belgium-home-map__background" height="8.7" width="9.6" x="486.6" y="293.6" />

        <g clipPath="url(#belgium-home-map-clip)">
          <path
            className="belgium-home-map__community belgium-home-map__community--north"
            d="M486.4 293.5H496.8V297.55H486.4Z"
          />
          <path
            className="belgium-home-map__community belgium-home-map__community--south"
            d="M486.4 297.15H496.8V302.5H486.4Z"
          />
          <path
            className="belgium-home-map__community belgium-home-map__community--east"
            d="M492.7 296.15L496.2 295.55L496.2 301.9L493.3 301.2Z"
          />
        </g>

        <path className="belgium-home-map__outline" d={BELGIUM_OUTLINE_PATH} />
      </svg>
    </div>
  );
}
